...
export default function Statistics() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-slate-800">Analysis Statistics</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {metrics.map((m) => (
          <div key={m.label} className="bg-white rounded-xl border border-slate-200 p-4">
            ...
            <p className="text-3xl font-bold text-slate-800 mt-1">{String(m.value)}</p>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <h2 className="font-semibold text-slate-700 mb-3">Species Distribution</h2>
        ...
        {/* Day/Night pie */}
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <h2 className="font-semibold text-slate-700 mb-3">Day / Night Distribution</h2>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie
      ...
      {/* Confidence series */}
      <div className="bg-white rounded-xl border border-slate-200 p-4">
        <h2 className="font-semibold text-slate-700 mb-3">Detection Confidence Distribution</h2>
        <ResponsiveContainer width="100%" height={200}>
          ...
          >
            ...
            <YAxis domain={[0, 1]} />
            <Tooltip />
            <Line type="monotone" dataKey="confidence" stroke="#16a34a" dot={false} strokeWidth={1.5} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
